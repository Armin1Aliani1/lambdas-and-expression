...
public class LambdaApplicationForTestOne {
    public static void main(String[] args) {
        ...
        int number = 100;
        // Function Descriptor
        Calculation calculationAddition = (int x, int y) -> x + y + 80;
        Calculation calculationSubtraction = (x, y) -> x - y;
        Calculation thisIsMyCalculation = (x, y) -> {
            int intOne = x + y;
            int intTwo = x - y;
            int intThree = x * y;
        ...
        System.out.println("This is my calculation : " + thisIsMyCalculation.calculate(20, 6));
